...
final class HupaRegisterStarterTheme
{
    ...
    public function register_starter_custom_footer_post_types(): void
    {
        register_post_type(
            ...
            array(
                ...
                'menu_icon' => self::get_svg_icons('columns'),
                'menu_position' => 81,
    ...
    public function register_starter_custom_header_post_types(): void
    {
        register_post_type(
            ...
            array(
                ...
                'show_in_nav_menus' => false,
                'exclude_from_search' => true,
                'menu_icon' => self::get_svg_icons('columns-gap'),
                'menu_position' => 80,
    ...
    public function load_hupa_starter_theme_admin_style()
    {
        ...
        // TODO Bootstrap JS
        wp_enqueue_script('hupa-hupa-starter-bs', Config::get('WP_THEME_ADMIN_URL') . 'admin-core/assets/js/bs/bootstrap.bundle.min.js', array(), $this->theme_version, true);
        //TODO Theme jQuery
