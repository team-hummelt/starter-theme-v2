...
const icon = function () {
  let isIcon = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/arrow-down.js");
...
/* harmony import */ var _components_icon_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/icon.js */ "./src/components/icon.js");
...
registerBlockType('hupa/bootstrap-button', {
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('BS-Button', 'bootscore'),
  icon: (0,_components_icon_js__WEBPACK_IMPORTED_MODULE_5__["default"])('bootstrap'),
  category: 'media',
  align: {
    type: 'string',
    default: 'center'
  ...
  keywords: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)(' BS-Button BY Jens Wiecker', 'bootscore'), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('BS-Button', 'bootscore')],
  supports: {
  ...
  edit: class extends Component {
    constructor(props) {
      ...
      this.onChangeExampleText = this.onChangeExampleText.bind(this);
      this.onChangeMyRichHeadingText = this.onChangeMyRichHeadingText.bind(this);
      this.onChangeMyRichBodyText = this.onChangeMyRichBodyText.bind(this);
      this.onChangeTextAlignment = this.onChangeTextAlignment.bind(this);
      this.onChangAutoComplete = this.onChangAutoComplete.bind(this);
      this.checkVisible = this.checkVisible.bind(this);
      this.setPost = this.setPost.bind(this);
      this.OnChangeComboValue = this.OnChangeComboValue.bind(this);
    }

    onChangeExampleText(exampleText) {
      this.props.setAttributes({
        exampleText
      });
    }

    onChangeMyRichHeadingText(myRichHeadingText) {
      this.props.setAttributes({
        myRichHeadingText
      });
    }

    onChangeMyRichBodyText(myRichBodyText) {
      this.props.setAttributes({
        myRichBodyText
      });
    }
    ...
    onChangAutoComplete(autoComplete) {
      this.props.setAttributes({
        autoComplete
      });
    }
    ...
    render() {
      ...
      const alignment = this.props.attributes.textAlignment != null ? 'has-text-align-' + this.props.attributes.textAlignment : '';
      const {
        postClass,
        attributes: {
          post = ''
      ...
      const MyComboboxControl = () => {
        ...
        return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.ComboboxControl, {
          className: inputComboClass,
          label: "Font Size",
          value: comboValue,
          onChange: setFontSize => this.OnChangeComboValue(setFontSize),
      ...
      const MyButton = _ref => {
        ...
        return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap__WEBPACK_IMPORTED_MODULE_7__["default"], {
      ...
      const autoConfigs = [{
        ...
        getOptionCompletion: option => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
          className: option.value,
          title: option.label
        }, "\xA0")
      }];

      const MyExternalLink = () => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.ExternalLink, {
        href: "https://wordpress.org"
      }, "WordPress.org"); //const {attributes, setAttributes} = props;
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        value: textAlignment,
        onChange: this.onChangeTextAlignment
        ...
        icon: (0,_components_icon_js__WEBPACK_IMPORTED_MODULE_5__["default"])('diagramm'),
        label: "Bold"
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.ToolbarGroup, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.ToolbarDropdownMenu, {
        ...
        className: inputMyRichHeadingText
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.RichText, {
        tagName: "h4",
        placeholder: "Write your heading here",
        value: myRichHeadingText,
        onChange: this.onChangeMyRichHeadingText
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.RichText, {
        className: inputMyRichBodyText,
        tagName: "p",
        placeholder: "Write your paragraph here",
        value: myRichBodyText,
        onChange: this.onChangeMyRichBodyText
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: inputAutoCompleteClass
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.RichText, {
        autocompleters: autoConfigs,
        value: autoComplete,
        onChange: this.onChangAutoComplete,
        placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)(`Type ${autoConfigs[0].triggerPrefix} to choose a ${autoConfigs[0].name}`)
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap__WEBPACK_IMPORTED_MODULE_7__["default"], {
        isSecondary: true,
        onClick: e => this.checkVisible(!this.state.isVisible)
      }, "Toggle Popover!", this.state.isVisible && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.Popover, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        style: {
          padding: "16px"
        }
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
        className: "bi-alarm"
      }, "\xA0"), " Popover is toggled!"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.SandBox, {
        html: "<p>Content</p>",
        title: "Sandbox",
        type: "embed" // scripts={[console.log("It's a sandbox")]}

      }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(MyExternalLink, null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: postClass
        ...
        onChange: newPost => this.setPost(newPost),
        withCreateSuggestion: true,
        createSuggestion: inputValue => this.setPost({
          post: { ...post,
            title: inputValue,
            type: "custom-url",
            id: Date.now(),
        ...
        createSuggestionButtonText: newValue => `${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("New:")} ${newValue}`
      ...
      }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(MyComboboxControl, null))));
    }
  ...
  save: props => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, " ", attributes.exampleText, "  "), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.RichText.Content, {
      tagName: "h2",
      value: attributes.myRichHeadingText
      ...
      tagName: "p",
      value: attributes.myRichBodyText
    }));
  }
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunktheme_bs_button"] = self["webpackChunktheme_bs_button"] || [];
